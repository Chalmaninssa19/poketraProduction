    ...
    <div class="col-8 grid-margin mx-auto">
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4">
                    <form action="./QuantityFormuleInsert" method="POST">
                        ...
                        <div class="row align-items-end">
                            <div class="form-group col-md-4">
                                ...
                                <select name="matiere" class="form-control form-control-sm input-height mt-2" id="matiereInput">
                            ...
                            <div class="form-group col-md-4">
                                <button type="button" onclick="addNewMatiereQuantity()"
                            ...
                            <div class="table-responsive mt-2">
                                <table class="table table-striped" id="matiereList">
