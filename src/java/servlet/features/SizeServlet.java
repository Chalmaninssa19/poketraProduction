...
public class SizeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //Liste
            String sql ="SELECT * FROM size WHERE status != 0";
            List<Size> sizes = (List<Size>) GenericDAO.directQuery(Size.class, sql, null);
            ...
            request.setAttribute("contentPage", "./pages/features/size.jsp");
