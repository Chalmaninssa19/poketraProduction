 ...
 * @author chalman
 */
@WebServlet(name = "DeleteMatiereServlet", urlPatterns = {"/DeleteMatiere"})
public class DeleteMatiereServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteMatiereServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeleteMatiereServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            matiere.setStatus(0);
            GenericDAO.updateById(matiere, idMatiere, null);
