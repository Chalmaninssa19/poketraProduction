 ...
 * @author chalman
 */
@WebServlet(name = "InsertRoleServlet", urlPatterns = {"/InsertRole"})
public class InsertRoleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertRoleServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertRoleServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("contentPage", "./pages/employe/insertRole.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            if(coefficient.trim().equals("") || coefficient == null) {
                profession = new Profession(name, salaire);
            } else {
                profession = new Profession(name, salaire, role, coefficient);
            }
            GenericDAO.save(profession, null);
