...
public class EtatStockServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(request.getAttribute("etatStockFilter") != null) {
                etatStock = (EtatStock)request.getAttribute("etatStockFilter");
            } else {
                etatStock = EtatStock.getEtatStock();
            }
            ...
            request.setAttribute("contentPage", "./pages/stockage/etatStock.jsp");
