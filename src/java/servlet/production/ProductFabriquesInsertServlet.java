 ...
 * @author chalman
 */
@WebServlet(name = "ProductFabriquesInsertServlet", urlPatterns = {"/ProductFabriquesInsert"})
public class ProductFabriquesInsertServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProductFabriquesInsertServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ProductFabriquesInsertServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            request.setAttribute("contentPage", "./pages/production/productFabriquesInsert.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductFabrique productFabrique = new ProductFabrique(product, quantite, dateFabrication);
            productFabrique.save();
            
            response.sendRedirect("ProductFabriquesList");
        } catch(Exception e) {
            request.setAttribute("error", e.getMessage());
            e.printStackTrace();
