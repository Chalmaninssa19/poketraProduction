 ...
 * @author chalman
 */
@WebServlet(name = "ParamGraduationServlet", urlPatterns = {"/ParamGraduation"})
public class ParamGraduationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ParamGraduationServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ParamGraduationServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String ajour = request.getParameter("ajour");
            String duree = request.getParameter("duree");

            ParamGraduation paramGraduation = new ParamGraduation(ancien, ajour, duree);
            GenericDAO.save(paramGraduation, null);
